...
if(!["786913915577303050", "786864139476795422"].some(role => message.member.roles.cache.get(role)) && (!message.member.hasPermission("ADMINISTRATOR"))) return message.reply(`Bu Komutu Kullanabilmek İçin Yetkin Bulunmuyor.`)
  
  
const kayıtlı = message.guild.roles.cache.find(r => r.id === '786864155436908545')
const kayıtsız = message.guild.roles.cache.find(r => r.id === '786864156103933964')
